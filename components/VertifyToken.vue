<template>
    <div class="verify-step">
        ...
        <div v-if="isChooseVerify" class="verify-step__choose-type">
        ...
        <div v-if="verifyType || !isChooseVerify" class="verify-step__confirm-wrap">
            ...
            <div class="verify-step-sms">
                <form @submit.prevent="sendForm">
                    ...
                    <div v-if="errors.token" class="input-error">
                        <small style="display: block">{{ errors.token[0] }}</small>
                    </div>
